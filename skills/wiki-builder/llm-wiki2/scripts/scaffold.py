...
*(none — run `PYTHONIOENCODING=utf-8 python scripts/audit_review.py <wiki-root> --open` to refresh)*
...
Next steps:
  ...
  5. Run lint periodically:  PYTHONIOENCODING=utf-8 python scripts/lint_wiki.py {root}
  6. Process feedback:       PYTHONIOENCODING=utf-8 python scripts/audit_review.py {root} --open
""")
