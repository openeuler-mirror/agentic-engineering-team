 ...
 * esbuild transpiles TypeScript + inlines all imported deps (e.g. js-yaml for
 * library-browser) and preserves `import.meta.url` so the compiled output
 * resolves its own __dirname to find scripts/_templates/ and
 * library-browser.config.yml.
 *
