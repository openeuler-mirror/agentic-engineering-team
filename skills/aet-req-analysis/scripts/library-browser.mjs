...
var CMD = "library-browser";
var CONFIG_PATH = join(__dirname, "library-browser.config.yml");
...
function loadConfig() {
  ...
  try {
    ...
    console.error(
      `Warning: failed to parse config ${CONFIG_PATH}: ${err.message} (ignoring, showing all fields)`
    );
    return {};
  }
}
