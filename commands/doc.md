---
description: 文档生成统一入口 - 智能识别用户需求并路由到对应的文档生成 skill（README、用户手册、技术分析、幻灯片、信息图、实践案例、Python API 文档、文档翻译、文档质量检查、mdbook 文档构建、问答对生成、wiki 知识库构建、GIF 动图生成）
agent: aet-doc
---
...
- **GIF Animation**: Generate GIF from images, extract frames from GIF, crop GIF, or convert video to GIF
...
- `/aet-doc 生成 GIF <图片/视频/动画路径>` - Generate GIF (image stitching / video conversion / frame extraction / cropping)
