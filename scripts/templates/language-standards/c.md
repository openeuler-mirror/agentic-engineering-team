...
> **Source**: Adapted from [`awesome-skills/code-review-skill`](https://github.com/awesome-skills/code-review-skill) (MIT License, Copyright (c) 2025 tt-a1i). Original at `reference/<filename>`. Full license: `./LICENSES/awesome-skills-code-review-skill.LICENSE`.
